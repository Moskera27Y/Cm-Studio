...
export default function Logo({ className = 'w-10 h-10' }) {
  return (
    <svg viewBox="0 0 512 512" className={className} role="img" aria-label="THARON">
      <title>THARON</title>
      <defs>
      ...
      <text x="256" y="330" textAnchor="middle" fontFamily="Arial, Helvetica, sans-serif" fontSize="200" fontWeight="900" letterSpacing="-6" fill="#ffffff">TH</text>
    </svg>
  );
}
